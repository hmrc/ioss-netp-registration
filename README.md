...
This is the repository for Import One Stop Shop NETP Backend

Frontend: https://github.com/hmrc/ioss-netp-registration-frontend

Stub: https://github.com/hmrc/ioss-netp-registration-stub

For more details on the Import One Stop Shop NETP service, including how to use the application, please refer to the instructions in the ioss-netp-registration-frontend repository.
...
```
sm2 --stop IOSS_NETP_REGISTRATION
```
and
```
